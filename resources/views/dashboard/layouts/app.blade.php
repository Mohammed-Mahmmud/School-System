                            ...
                            <div class="dropdown-menu dropdown-menu-lg" id="search-dropdown">
                                <div data-simplebar="" style="max-height: 320px;">
                                    ...
                                    <div class="notification-list">
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item notify-item py-2">
                                            <div class="d-flex">
                                                <img src="{{asset('dashboard')}}/assets/images/users/avatar-5.jpg" class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                                <div class="flex-1">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="dropdown ms-1 topbar-head-dropdown header-item">
                            <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img id="header-lang-img" src="{{asset('dashboard')}}/assets/images/flags/us.svg" alt="Header Language" height="20" class="rounded">
                            </button>
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="sp" title="Spanish">
                                    <img src="{{asset('dashboard')}}/assets/images/flags/spain.svg" alt="user-image" class="me-2 rounded" height="18">
                                    <span class="align-middle">Española</span>
                                </a>

                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="gr" title="German">
                                    <img src="{{asset('dashboard')}}/assets/images/flags/germany.svg" alt="user-image" class="me-2 rounded" height="18"> <span class="align-middle">Deutsche</span>
                                </a>

                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="it" title="Italian">
                                    <img src="{{asset('dashboard')}}/assets/images/flags/italy.svg" alt="user-image" class="me-2 rounded" height="18">
                                    <span class="align-middle">Italiana</span>
                                </a>

                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="ru" title="Russian">
                                    <img src="{{asset('dashboard')}}/assets/images/flags/russia.svg" alt="user-image" class="me-2 rounded" height="18">
                                    <span class="align-middle">русский</span>
                                </a>

                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="ch" title="Chinese">
                                    <img src="{{asset('dashboard')}}/assets/images/flags/china.svg" alt="user-image" class="me-2 rounded" height="18">
                                    <span class="align-middle">中国人</span>
                                </a>

                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="fr" title="French">
                                    <img src="{{asset('dashboard')}}/assets/images/flags/french.svg" alt="user-image" class="me-2 rounded" height="18">
                                    <span class="align-middle">français</span>
                                </a>

                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="ar" title="Arabic">
                                    <img src="{{asset('dashboard')}}/assets/images/flags/ae.svg" alt="user-image" class="me-2 rounded" height="18">
                                    ...
                                    <div class="p-3">
                                            ...
                                            <div class="d-flex">
                                                <div class="avatar-sm me-3 flex-shrink-0">
                                                    <div class="avatar-title bg-light rounded">
                                                        <img src="{{asset('dashboard')}}/assets/images/products/32/img-1.png" class="avatar-xs" alt="user-pic">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="d-block dropdown-item product text-wrap p-2">
                                            <div class="d-flex">
                                                <div class="avatar-sm me-3 flex-shrink-0">
                                                    <div class="avatar-title bg-light rounded">
                                                        <img src="{{asset('dashboard')}}/assets/images/products/32/img-5.png" class="avatar-xs" alt="user-pic">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                        ...
                                        <div class="d-block dropdown-item product text-wrap p-2">
                                            <div class="d-flex">
                                                <div class="avatar-sm me-3 flex-shrink-0">
                                                    <div class="avatar-title bg-light rounded">
                                                        <img src="{{asset('dashboard')}}/assets/images/products/32/img-10.png" class="avatar-xs" alt="user-pic">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                                    <p class="mb-1 fs-sm text-muted">Fashion</p>
                                        ...
                                        <div class="d-block dropdown-item product text-wrap p-2">
                                            <div class="d-flex">
                                                <div class="avatar-sm me-3 flex-shrink-0">
                                                    <div class="avatar-title bg-light rounded">
                                                        <img src="{{asset('dashboard')}}/assets/images/products/32/img-11.png" class="avatar-xs" alt="user-pic">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                                    <p class="mb-1 fs-sm text-muted">Fashion</p>
                                        ...
                                        <div class="d-block dropdown-item product text-wrap p-2">
                                            <div class="d-flex">
                                                <div class="avatar-sm me-3 flex-shrink-0">
                                                    <div class="avatar-title bg-light rounded">
                                                        <img src="{{asset('dashboard')}}/assets/images/products/32/img-8.png" class="avatar-xs" alt="user-pic">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                                    <p class="mb-1 fs-sm text-muted">Fashion</p>
                                    ...
                                    <div data-simplebar="" style="max-height: 300px;" class="pe-2">
                                        ...
                                        <div class="text-reset notification-item d-block dropdown-item position-relative unread-message">
                                            <div class="d-flex">
                                                <div class="position-relative me-3 flex-shrink-0">
                                                    <img src="{{asset('dashboard')}}/assets/images/users/32/avatar-2.jpg" class="rounded-circle avatar-xs" alt="user-pic">
                                        ...
                                        <div class="text-reset notification-item d-block dropdown-item position-relative">
                                            <div class="d-flex">
                                                ...
                                                <div class="position-relative me-3 flex-shrink-0">
                                                    <img src="{{asset('dashboard')}}/assets/images/users/32/avatar-8.jpg" class="rounded-circle avatar-xs" alt="user-pic">
                        ...
                        <div class="dropdown ms-sm-3 header-item topbar-user">
                            <button type="button" class="btn shadow-none" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="d-flex align-items-center">
                                    <img class="rounded-circle header-profile-user" src="{{asset('dashboard')}}/assets/images/users/32/avatar-1.jpg" alt="Header Avatar">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center gap-1">
                                                            <div class="flex-shrink-0">
                                                                <img src="{{asset('dashboard')}}/assets/images/users/48/avatar-2.jpg" alt="" class="avatar-sm rounded-circle p-1">
                                                            </div>
                                                            <div class="flex-grow-1">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center gap-1">
                                                            <div class="flex-shrink-0">
                                                                <img src="{{asset('dashboard')}}/assets/images/users/48/avatar-7.jpg" alt="" class="avatar-sm rounded-circle p-1">
                                                            </div>
                                                            <div class="flex-grow-1">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center gap-1">
                                                            <div class="flex-shrink-0">
                                                                <img src="{{asset('dashboard')}}/assets/images/users/48/avatar-4.jpg" alt="" class="avatar-sm rounded-circle p-1">
                                                            </div>
                                                            <div class="flex-grow-1">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center gap-1">
                                                            <div class="flex-shrink-0">
                                                                <img src="{{asset('dashboard')}}/assets/images/users/48/avatar-5.jpg" alt="" class="avatar-sm rounded-circle p-1">
                                                            </div>
                                                            <div class="flex-grow-1">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center gap-1">
                                                            <div class="flex-shrink-0">
                                                                <img src="{{asset('dashboard')}}/assets/images/users/48/avatar-6.jpg" alt="" class="avatar-sm rounded-circle p-1">
                                                            </div>
                                                            <div class="flex-grow-1">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center gap-1">
                                                            <div class="flex-shrink-0">
                                                                <img src="{{asset('dashboard')}}/assets/images/users/48/avatar-1.jpg" alt="" class="avatar-sm rounded-circle p-1">
                                                            </div>
                                                            <div class="flex-grow-1">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center gap-1">
                                                            <div class="flex-shrink-0">
                                                                <img src="{{asset('dashboard')}}/assets/images/users/48/avatar-8.jpg" alt="" class="avatar-sm rounded-circle p-1">
                                                            </div>
                                                            <div class="flex-grow-1">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                                            ...
                                            <tbody class="list">
                                                <tr>
                                                    ...
                                                    <td class="shop">
                                                        <img src="{{asset('dashboard')}}/assets/images/companies/img-7.png" alt="" class="avatar-xxs rounded-circle">
                                                    </td>
                                                    <td class="customer">
                                                        Alex Smith
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="shop">
                                                        <img src="{{asset('dashboard')}}/assets/images/companies/img-1.png" alt="" class="avatar-xxs rounded-circle">
                                                    </td>
                                                    <td class="customer">
                                                        Jansh Brown
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="shop">
                                                        <img src="{{asset('dashboard')}}/assets/images/companies/img-2.png" alt="" class="avatar-xxs rounded-circle">
                                                    </td>
                                                    <td class="customer">
                                                        Ayaan Bowen
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="shop">
                                                        <img src="{{asset('dashboard')}}/assets/images/companies/img-3.png" alt="" class="avatar-xxs rounded-circle">
                                                    </td>
                                                    <td class="customer">
                                                        Prezy Mark
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="shop">
                                                        <img src="{{asset('dashboard')}}/assets/images/companies/img-4.png" alt="" class="avatar-xxs rounded-circle">
                                                    </td>
                                                    <td class="customer">
                                                        Vihan Hudda
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="shop">
                                                        <img src="{{asset('dashboard')}}/assets/images/companies/img-5.png" alt="" class="avatar-xxs rounded-circle">
                                                    </td>
                                                    <td class="customer">
                                                        Vihan Hudda
                                                    </td>
                                        ...
                                        <div class="noresult" style="display: none">
                                            <div class="text-center">
                                                <lord-icon src="../../msoeawqm.json" trigger="loop" colors="primary:#405189,secondary:#0ab39c" style="width:75px;height:75px"></lord-icon>
                                        ...
                                        <div class="vstack gap-2">
                                            <div class="p-2 border border-dashed">
                                                <div class="d-flex align-items-center gap-2">
                                                    <div class="avatar-sm flex-shrink-0">
                                                        <div class="avatar-title bg-light rounded">
                                                            <img src="{{asset('dashboard')}}/assets/images/products/32/img-1.png" alt="" class="avatar-xs">
                                                        </div>
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <a href="#!">
                                            ...
                                            <div class="p-2 border border-dashed">
                                                <div class="d-flex align-items-center gap-2">
                                                    <div class="avatar-sm flex-shrink-0">
                                                        <div class="avatar-title bg-light rounded">
                                                            <img src="{{asset('dashboard')}}/assets/images/products/32/img-2.png" alt="" class="avatar-xs">
                                                        </div>
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <a href="#!">
                                            ...
                                            <div class="p-2 border border-dashed">
                                                <div class="d-flex align-items-center gap-2">
                                                    <div class="avatar-sm flex-shrink-0">
                                                        <div class="avatar-title bg-light rounded">
                                                            <img src="{{asset('dashboard')}}/assets/images/products/32/img-3.png" alt="" class="avatar-xs">
                                                        </div>
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <a href="#!">
                                            ...
                                            <div class="p-2 border border-dashed">
                                                <div class="d-flex align-items-center gap-2">
                                                    <div class="avatar-sm flex-shrink-0">
                                                        <div class="avatar-title bg-light rounded">
                                                            <img src="{{asset('dashboard')}}/assets/images/products/32/img-4.png" alt="" class="avatar-xs">
                                                        </div>
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <a href="#!">
                                            ...
                                            <div class="p-2 border border-dashed">
                                                <div class="d-flex align-items-center gap-2">
                                                    <div class="avatar-sm flex-shrink-0">
                                                        <div class="avatar-title bg-light rounded">
                                                            <img src="{{asset('dashboard')}}/assets/images/products/32/img-5.png" alt="" class="avatar-xs">
                                                        </div>
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <a href="#!">
                                            ...
                                            <div class="p-2 border border-dashed">
                                                <div class="d-flex align-items-center gap-2">
                                                    <div class="avatar-sm flex-shrink-0">
                                                        <div class="avatar-title bg-light rounded">
                                                            <img src="{{asset('dashboard')}}/assets/images/products/32/img-6.png" alt="" class="avatar-xs">
                                                        </div>
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <a href="#!">
                                    ...
                                    <div data-simplebar="" class="px-3" style="max-height: 258px;">
                                        <div class="acitivity-timeline acitivity-main">
                                            ...
                                            <div class="acitivity-item py-3 d-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="{{asset('dashboard')}}/assets/images/users/32/avatar-2.jpg" alt="" class="avatar-xs rounded-circle acitivity-avatar">
                                                </div>
                                                <div class="flex-grow-1 ms-3">
                    ...
                    <div class="row g-0">
                        <div class="col-lg-5">
                            <div class="bg-primary-subtle p-5 h-100">
                                <div class="p-lg-4">
                                    <img src="{{asset('dashboard')}}/assets/images/products/img-3.png" alt="" class="img-fluid">
                                </div>
                            </div>
                        </div>
                        <!--end col-->
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme01">
                                    <img src="{{asset('dashboard')}}/assets/images/custom-theme/light-mode.png" alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme02">
                                    <img src="{{asset('dashboard')}}/assets/images/custom-theme/material.png" alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme03">
                                    <img src="{{asset('dashboard')}}/assets/images/custom-theme/creative.png" alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme04">
                                    <img src="{{asset('dashboard')}}/assets/images/custom-theme/minimal.png" alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme05">
                                    <img src="{{asset('dashboard')}}/assets/images/custom-theme/modern.png" alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme06">
                                    <img src="{{asset('dashboard')}}/assets/images/custom-theme/interaction.png" alt="" class="img-fluid">
                                </label>
                            </div>
                            ...
                            <div class="col-6">
                                <div class="form-check card-radio dark">
                                    ...
                                    <label class="form-check-label p-0 bg-transparent" for="layout-mode-dark">
                                        <img src="{{asset('dashboard')}}/assets/images/custom-theme/dark-mode.png" alt="" class="img-fluid">
                                    </label>
                                </div>
                            ...
                            <div class="col-6">
                                <div class="form-check card-radio brand">
                                    ...
                                    <label class="form-check-label cursor-none p-0 bg-transparent opacity-75" for="layout-mode-brand">
                                        <img src="{{asset('dashboard')}}/assets/images/custom-theme/brand-mode.png" alt="" class="img-fluid">
                                    </label>
                                </div>
                        ...
                        <div class="d-flex gap-2 flex-wrap img-switch">
                            ...
                            <div class="form-check sidebar-setting card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-01">
                                    <img src="{{asset('dashboard')}}/assets/images/sidebar/img-sm-1.jpg" alt="" class="avatar-md w-auto object-cover">
                                </label>
                            </div>
                            ...
                            <div class="form-check sidebar-setting card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-02">
                                    <img src="{{asset('dashboard')}}/assets/images/sidebar/img-sm-2.jpg" alt="" class="avatar-md w-auto object-cover">
                                </label>
                            </div>
                            <div class="form-check sidebar-setting card-radio">
                                <input class="form-check-input" type="radio" name="data-sidebar-image" id="sidebarimg-03" value="img-3">
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-03">
                                    <img src="{{asset('dashboard')}}/assets/images/sidebar/img-sm-3.jpg" alt="" class="avatar-md w-auto object-cover">
                                </label>
                            </div>
                            <div class="form-check sidebar-setting card-radio">
                                <input class="form-check-input" type="radio" name="data-sidebar-image" id="sidebarimg-04" value="img-4">
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-04">
                                    <img src="{{asset('dashboard')}}/assets/images/sidebar/img-sm-4.jpg" alt="" class="avatar-md w-auto object-cover">
                                </label>
                            </div>
                        </div>
                    </div>
